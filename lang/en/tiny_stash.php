...
$string['additemlocation'] = 'Add item and create location';
...
$string['createitems'] = 'Create items and a location to configure it here.';
...
$string['help2'] = 'This editor plugin allows you to create items and tie them to a location. The location and its associated information is what is added to this text area for students to interact with.';
...
$string['items'] = 'Items';
$string['itemsandlocation'] = 'Location configuration and insertion';
$string['itemsandtrade'] = 'Trade insertion';
$string['location'] = 'Location';
$string['locationhelp'] = 'Locations are a way to place items into the course multiple times. If you have a common item that you reward your students with (e.g. Money), instead of creating multiple money items, you just create another location for that item. Each item can be configured to limit how many of the item are available, how often they spawn, and if there is an unlimited supply.';
$string['locationhelp2'] = 'The Location configurations have a name for your benefit only. This is used to remind you were this item is located (if you are in the general management screen).';
$string['locationhelp3'] = 'This plugin will have a guess at a name for your location. You are free to change it to anything else.';
$string['locationhelp4'] = 'Locations can be displayed in three different ways: As a link, Only and image, or as an image with a button. The last option is the most obvious for students to identify as a stash item.';
$string['locationhelplink'] = 'Locations and what they are for';
$string['locationneeded'] = 'Location needed';
...
$string['nolocations'] = 'Please create a location to configure here, before being inserted into this editor.';
...
$string['tradehelp3'] = 'Trade widgets are put into the course in the same way that locations are. Selecting a trade from the trade insertion screen will show a preview of what will be inserted.';
